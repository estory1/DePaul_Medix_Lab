...
#
# Executes a Theano-based convolutional neural network for image classification over the MNIST dataset.
#
# Src:                http://deeplearning.net/tutorial/code/convolutional_mlp.py
#   via tutorial at:  http://www.deeplearning.net/tutorial/lenet.html#lenet
#
# Author: Evan story
# Created: 20151118
...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    layer0 = LeNetConvPoolLayer(
        rng,
        input=layer0_input,
        image_shape=(batch_size, 1, img_px_len_x, img_px_len_y),
    ...
    layer3 = LogisticRegression(input=layer2.output, n_in=batch_size, n_out=lidc_n_out_malignancy)
...
if __name__ == '__main__':
  if len(sys.argv) == 1:
    evaluate_lenet5()
    # print "ERROR: Too few parameters. Need: " + str(len(sys.argv)) + " params."
    # sys.exit("\tSyntax: " + sys.argv[0] + " FOLDER_PATH" + os.path.sep + "mnist.pkl.gz")
  else:
